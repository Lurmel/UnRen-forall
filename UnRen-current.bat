...
set "choice3.fr=Déobfusquer lors de la décompression des fichiers RPA %YEL%(Utiliser le code de base)"
...
set "mquest.fr=Votre choix (1-7,a-l,t,+,- par défaut [%MDEFS2%]) : "
set "mquest.es=Su elección (1-7,a-l,t,+,- por defecto [%MDEFS2%]): "
set "mquest.it=La tua scelta (1-7,a-l,t,+,- predefinito [%MDEFS2%]): "
set "mquest.de=Ihre Wahl (1-7,a-l,t,+,- für Standard [%MDEFS2%]): "
set "mquest.ru=Ваш выбор (1-7,a-l,t,+,- по умолчанию [%MDEFS2%]): "
...
set "decm1.fr=Échec de la création de decomp.cab. !UNACONT.%LNG%!"
...
set "decm1.ru=Не удалось создать decomp.cab. !UNACONT.%LNG%!"
